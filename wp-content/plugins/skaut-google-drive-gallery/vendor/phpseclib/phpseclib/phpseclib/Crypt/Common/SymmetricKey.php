 ...
 */
namespace Sgdg\Vendor\phpseclib3\Crypt\Common;
...
use Sgdg\Vendor\phpseclib3\Exception\BadDecryptionException;
use Sgdg\Vendor\phpseclib3\Exception\BadModeException;
use Sgdg\Vendor\phpseclib3\Exception\InconsistentSetupException;
...
use Sgdg\Vendor\phpseclib3\Math\BinaryField;
use Sgdg\Vendor\phpseclib3\Math\PrimeField;
/**
 * Base Class for all \phpseclib3\Crypt\* cipher classes
 *
 * @author  Jim Wigginton <terrafrost@php.net>
