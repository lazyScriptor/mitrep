 ...
 */
namespace Sgdg\Vendor\phpseclib3\Math\BigInteger\Engines\PHP;

use Sgdg\Vendor\phpseclib3\Math\BigInteger\Engines\Engine;
use Sgdg\Vendor\phpseclib3\Math\BigInteger\Engines\PHP;
use Sgdg\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Reductions\PowerOfTwo;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
