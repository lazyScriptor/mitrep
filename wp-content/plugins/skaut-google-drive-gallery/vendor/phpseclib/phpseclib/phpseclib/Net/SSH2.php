 ...
 */
namespace Sgdg\Vendor\phpseclib3\Net;

use Sgdg\Vendor\phpseclib3\Common\Functions\Strings;
use Sgdg\Vendor\phpseclib3\Crypt\Blowfish;
use Sgdg\Vendor\phpseclib3\Crypt\ChaCha20;
use Sgdg\Vendor\phpseclib3\Crypt\Common\AsymmetricKey;
use Sgdg\Vendor\phpseclib3\Crypt\Common\PrivateKey;
use Sgdg\Vendor\phpseclib3\Crypt\Common\PublicKey;
use Sgdg\Vendor\phpseclib3\Crypt\Common\SymmetricKey;
use Sgdg\Vendor\phpseclib3\Crypt\DH;
use Sgdg\Vendor\phpseclib3\Crypt\DSA;
use Sgdg\Vendor\phpseclib3\Crypt\EC;
use Sgdg\Vendor\phpseclib3\Crypt\Hash;
use Sgdg\Vendor\phpseclib3\Crypt\Random;
use Sgdg\Vendor\phpseclib3\Crypt\RC4;
use Sgdg\Vendor\phpseclib3\Crypt\Rijndael;
use Sgdg\Vendor\phpseclib3\Crypt\RSA;
use Sgdg\Vendor\phpseclib3\Crypt\TripleDES;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use Sgdg\Vendor\phpseclib3\Crypt\Twofish;
use Sgdg\Vendor\phpseclib3\Exception\ConnectionClosedException;
use Sgdg\Vendor\phpseclib3\Exception\InsufficientSetupException;
use Sgdg\Vendor\phpseclib3\Exception\NoSupportedAlgorithmsException;
use Sgdg\Vendor\phpseclib3\Exception\UnableToConnectException;
use Sgdg\Vendor\phpseclib3\Exception\UnsupportedAlgorithmException;
use Sgdg\Vendor\phpseclib3\Exception\UnsupportedCurveException;
use Sgdg\Vendor\phpseclib3\Math\BigInteger;
use Sgdg\Vendor\phpseclib3\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @author  Jim Wigginton <terrafrost@php.net>
