...
use Sgdg\Vendor\Monolog\Utils;
use Sgdg\Vendor\PhpConsole\Connector;
use Sgdg\Vendor\PhpConsole\Handler;
use Sgdg\Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('Sgdg\\Vendor\\PhpConsole\\Connector')) {
