...
namespace Sgdg\Vendor\Psr\Log\Test;

use Sgdg\Vendor\Psr\Log\LoggerInterface;
use Sgdg\Vendor\Psr\Log\LogLevel;
use Sgdg\Vendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Sgdg\\Vendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Sgdg\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Sgdg\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
