 ...
 */
namespace Sgdg\Vendor\Google\Auth\Credentials;

use Sgdg\Vendor\Google\Auth\CredentialsLoader;
use Sgdg\Vendor\Google\Auth\GetQuotaProjectInterface;
use Sgdg\Vendor\Google\Auth\HttpHandler\HttpClientCache;
use Sgdg\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use Sgdg\Vendor\Google\Auth\Iam;
use Sgdg\Vendor\Google\Auth\ProjectIdProviderInterface;
use Sgdg\Vendor\Google\Auth\SignBlobInterface;
use Sgdg\Vendor\GuzzleHttp\Exception\ClientException;
use Sgdg\Vendor\GuzzleHttp\Exception\ConnectException;
use Sgdg\Vendor\GuzzleHttp\Exception\RequestException;
use Sgdg\Vendor\GuzzleHttp\Exception\ServerException;
