 ...
 * the License.
 */
namespace Sgdg\Vendor\Google\Service\Drive\Resource;

use Sgdg\Vendor\Google\Service\Drive\Channel;
use Sgdg\Vendor\Google\Service\Drive\DriveFile;
use Sgdg\Vendor\Google\Service\Drive\FileList;
use Sgdg\Vendor\Google\Service\Drive\GeneratedIds;
use Sgdg\Vendor\Google\Service\Drive\LabelList;
use Sgdg\Vendor\Google\Service\Drive\ModifyLabelsRequest;
use Sgdg\Vendor\Google\Service\Drive\ModifyLabelsResponse;
/**
 ...
 *  </code>
 */
class Files extends \Sgdg\Vendor\Google\Service\Resource
{
    /**
...
\class_alias(Files::class, 'Sgdg\\Vendor\\Google_Service_Drive_Resource_Files');
