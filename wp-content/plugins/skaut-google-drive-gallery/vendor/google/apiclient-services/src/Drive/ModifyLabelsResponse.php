...
class ModifyLabelsResponse extends \Sgdg\Vendor\Google\Collection
{
...
\class_alias(ModifyLabelsResponse::class, 'Sgdg\\Vendor\\Google_Service_Drive_ModifyLabelsResponse');
