...
class DriveFileImageMediaMetadata extends \Sgdg\Vendor\Google\Model
{
    /**
     * @var float
     */
...
\class_alias(DriveFileImageMediaMetadata::class, 'Sgdg\\Vendor\\Google_Service_Drive_DriveFileImageMediaMetadata');
