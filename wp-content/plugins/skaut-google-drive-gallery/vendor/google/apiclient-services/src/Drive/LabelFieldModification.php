...
class LabelFieldModification extends \Sgdg\Vendor\Google\Collection
{
...
\class_alias(LabelFieldModification::class, 'Sgdg\\Vendor\\Google_Service_Drive_LabelFieldModification');
