...
class ModifyLabelsRequest extends \Sgdg\Vendor\Google\Collection
{
...
\class_alias(ModifyLabelsRequest::class, 'Sgdg\\Vendor\\Google_Service_Drive_ModifyLabelsRequest');
