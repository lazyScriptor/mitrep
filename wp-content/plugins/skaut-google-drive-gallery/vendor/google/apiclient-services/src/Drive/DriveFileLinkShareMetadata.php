...
class DriveFileLinkShareMetadata extends \Sgdg\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveFileLinkShareMetadata::class, 'Sgdg\\Vendor\\Google_Service_Drive_DriveFileLinkShareMetadata');
