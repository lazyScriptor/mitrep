...
class DriveFileCapabilities extends \Sgdg\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveFileCapabilities::class, 'Sgdg\\Vendor\\Google_Service_Drive_DriveFileCapabilities');
