...
class DriveFileShortcutDetails extends \Sgdg\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DriveFileShortcutDetails::class, 'Sgdg\\Vendor\\Google_Service_Drive_DriveFileShortcutDetails');
