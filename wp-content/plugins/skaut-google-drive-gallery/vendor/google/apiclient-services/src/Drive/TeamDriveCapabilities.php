...
class TeamDriveCapabilities extends \Sgdg\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(TeamDriveCapabilities::class, 'Sgdg\\Vendor\\Google_Service_Drive_TeamDriveCapabilities');
