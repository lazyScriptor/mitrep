...
class DriveFileContentHints extends \Sgdg\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DriveFileContentHints::class, 'Sgdg\\Vendor\\Google_Service_Drive_DriveFileContentHints');
