...
class TeamDriveRestrictions extends \Sgdg\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(TeamDriveRestrictions::class, 'Sgdg\\Vendor\\Google_Service_Drive_TeamDriveRestrictions');
