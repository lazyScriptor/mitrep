 ...
 * the License.
 */
namespace Sgdg\Vendor\Google\Service\Drive;

class PermissionTeamDrivePermissionDetails extends \Sgdg\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(PermissionTeamDrivePermissionDetails::class, 'Sgdg\\Vendor\\Google_Service_Drive_PermissionTeamDrivePermissionDetails');
