...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('Sgdg\\Vendor\\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['Sgdg\\Vendor\\Google\\Client' => 'Google_Client', 'Sgdg\\Vendor\\Google\\Service' => 'Google_Service', 'Sgdg\\Vendor\\Google\\Service\\Resource' => 'Google_Service_Resource', 'Sgdg\\Vendor\\Google\\Model' => 'Google_Model', 'Sgdg\\Vendor\\Google\\Collection' => 'Google_Collection'];
