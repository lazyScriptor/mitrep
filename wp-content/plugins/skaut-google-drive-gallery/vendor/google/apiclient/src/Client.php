...
use DomainException;
use Sgdg\Vendor\Google\AccessToken\Revoke;
use Sgdg\Vendor\Google\AccessToken\Verify;
...
use Sgdg\Vendor\Google\AuthHandler\AuthHandlerFactory;
use Sgdg\Vendor\Google\Http\REST;
use Sgdg\Vendor\GuzzleHttp\Client as GuzzleClient;
...
class Client
{
    ...
    protected function createDefaultHttpClient()
    {
        ...
        } elseif (\defined('Sgdg\\Vendor\\GuzzleHttp\\ClientInterface::VERSION')) {
