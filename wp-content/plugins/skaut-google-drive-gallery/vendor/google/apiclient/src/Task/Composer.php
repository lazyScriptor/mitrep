 ...
 * the License.
 */
namespace Sgdg\Vendor\Google\Task;

use Sgdg\Vendor\Composer\Script\Event;
use InvalidArgumentException;
use Sgdg\Vendor\Symfony\Component\Filesystem\Filesystem;
use Sgdg\Vendor\Symfony\Component\Finder\Finder;
class Composer
{
    /**
