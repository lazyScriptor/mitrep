 ...
 */
namespace Sgdg\Vendor\Google\Http;

use Sgdg\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use Sgdg\Vendor\Google\Service\Exception as GoogleServiceException;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (\interface_exists('Sgdg\\Vendor\\GuzzleHttp\\Message\\ResponseInterface') && $response instanceof \Sgdg\Vendor\GuzzleHttp\Message\ResponseInterface) {
